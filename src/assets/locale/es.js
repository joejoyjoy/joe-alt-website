const spanishTranslation = {
  /*** Componentes de la Páginas ***/

  // COMPONENTE CABEZA
  header_logo_alt: "Logotipo del sitio web. Representando J",
  header_nav_link1: "Sobre Mi",
  header_nav_link2: "Experiencia",
  header_nav_link3: "Proyectos",
  header_nav_link4: "Reseñas",
  header_nav_link5: "Contacta",
  ...
  emailJSForm_email_placeholder: "Introduce tu email",
  emailJSForm_msg_placeholder: "Escribe su mensaje",

  // MODAL SWEETALERT2
  sweetAlert_confirmBtn: "Cerrar",
  sweetAlert_success_title: "¡Enviado exitosamente!",
  sweetAlert_error_title: "¡Se produjo un error!",
