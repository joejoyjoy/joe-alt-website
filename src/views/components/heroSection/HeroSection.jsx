    ...
    <>
      <section id="heroLink" className="hero-section">
        <div className="hero-section__content">
          <p className="hero-section__content--welcome">
            {t("heroSection_welcome")}
          </p>
          <h1 className="hero-section__content--title">
            <span className="hero-section__content--title__name">Joe Alt.</span>
            <span className="hero-section__content--title__position">
              {t("heroSection_position")}
            </span>
          </h1>
          <p className="hero-section__content--description">
            <Trans
              i18nKey="heroSection_description"
              components={{
                aTag: (
                  <a
          ...
          <span className="hero-section__content--btns">
            <Link
              ...
              offset={-25}
              href="\"
              className="hero-section__content--btns__action"
            >
              {t("heroSection_btns_action")}
            </Link>
          </span>
        </div>
        <div className="hero-section__picture">
          <img
            src={heroSection}
            alt="Joe Alt floating projects"
            className="hero-section__picture--image"
          />
        </div>
      </section>
